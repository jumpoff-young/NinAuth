        ...
        <div className="w-full max-w-full lg:max-w-[65.76%] m-auto flex flex-col md:flex-row lg:flex-row py-12 lg:pt-16 lg:pb-[115px]">
          <div className=" w-full max-w-full flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-8 lg:gap-[88px]">
              ...
              <div className="w-full max-w-full  flex flex-col-reverse items-center gap-8 lg:flex-row lg:justify-between">
                <div className="flex flex-row items-center gap-[38px]">
                  ...
                  <div className="flex flex-col gap-[48px] lg:gap-[96px] items-center w-full max-w-full lg:max-w-[380px] text-[17px] font-medium text-blackCustom leading-[30.6px]">
                    ...
                    <p className="text-[17px] font-medium text-blackCustom leading-[30.6px]">
                      Download the NINAAuth app to complete the onboarding
                      process.
                    </p>
                    <p className="text-[17px] font-medium text-blackCustom leading-[30.6px]">
                      You are all set! Once all details have been approved you
              ...
              <div className="w-full max-w-full flex rounded-[20px] p-6 flex-col gap-6 bg-[#F9F5EB]">
                <div className="flex flex-col gap-6">
                  <p className="text-base font-bold text-blackCustom tracking-normal">
                    What you need
                  </p>
                </div>
                <div className="flex flex-col gap-6 items-center lg:items-end sm:flex-row md:flex-row lg:flex-row sm:justify-between md:justify-between lg:justify-between">
                  <ul className="list-disc pl-3 flex flex-col gap-4">
                    <li>A smartphone with internet connection</li>
                    <li>Spare 4-8minutes of your time</li>
                  </ul>
                  <DownloadLinks />
                </div>
              </div>
